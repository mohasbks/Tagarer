        ...
        <div className="min-h-screen bg-gradient-to-br from-accent-50 via-white to-accent-50/30 pt-24 pb-16">
            <div className="section-container">
                <div className="max-w-2xl mx-auto">
                    ...
                    >
                        <h1 className="text-3xl font-bold text-primary-500 mb-2">إنشاء حساب جديد</h1>
                        <p className="text-neutral-600 mb-8">انضم إلى آلاف المستخدمين واحصل على وصول فوري</p>
                        ...
                        <div className="relative mb-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white text-neutral-500">أو سجل بالبريد</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    >
                                        ...
                                        <span className="font-semibold">فرد</span>
                                    </button>
                                    <button
                                        type="button"
                            ...
                            <div>
                                ...
                                <p className="text-xs text-neutral-500 mt-1">يجب أن تكون 8 أحرف على الأقل</p>
                            </div>
